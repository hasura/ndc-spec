...
use ndc_test::{
    ...
    configuration::{self, TestConfiguration, TestGenerationConfiguration, TestOptions},
...
enum Commands {
    ...
    Generate {
        ...
        operation_type: Vec<configuration::FixtureOperationType>,
        #[arg(
            long,
            value_name = "STRING",
            value_parser, 
        ...
        #[arg(
            long,
            default_value = "false",
            help = "Generate random responses locally without fetching results from the connector endpoint"
        )]
        dry_run: bool,
    },
}
...
async fn main() {
    match Options::parse().command {
        ...
        Commands::Generate {
            ...
            let generate_configuration = configuration::FixtureConfiguration {
                seed,
                snapshots_dir,
